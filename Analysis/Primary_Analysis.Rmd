...
(4) Weekly_death ~  s(days_since_first) + scaled independent variables + positive test ratio with only 1-3 weeks lag without the current postive test ratio + the PCA of movement + the time since the mask policy with 3 levels + random intercept
...
(5) Weekly_death ~  s(days_since_first) + scaled independent variables + positive test ratio with only 1-3 weeks lag without the current postive test ratio + the residential movement with 3 weeks lag + the time since the mask policy with 3 levels  + random intercept
...
(6) Weekly_death ~   linear days_since_first + scaled independent variables + positive test ratio with 3 weeks lag + random intercept + random slope for days_since_first

```{r,echo=FALSE}

mod6 = gamm4(weekly_death~ weeks_since_first + factor(q_popdensity)
             + scale(Age_gp1) + scale(Age_gp3) + scale(Age_gp4) 
             + scale(poverty_perc) 
             + scale(Black.perc) + scale(Hispanic.or.Latino.perc)
             + scale(temp) + scale(perc)
...
(7) Weekly_death ~ linear days_since_first  + scaled independent variables + positive test ratio with only 1-3 weeks lag without the current postive test ratio +  the PCA of movement + the time since the mask policy with 3 levels  +  random intercept + random slope for days_since_first

```{r,echo=FALSE}

mod7 = gamm4(weekly_death~ weeks_since_first  + factor(q_popdensity)
             + scale(Age_gp1) + scale(Age_gp3) + scale(Age_gp4) 
             + scale(poverty_perc) 
             + scale(Black.perc) + scale(Hispanic.or.Latino.perc)
             + scale(temp) + scale(perc)
...
(8) Weekly_death ~ linear days_since_first  + scaled independent variables + positive test ratio with only 1-3 weeks lag without the current postive test ratio +  the residential movement with 3 weeks lag + the time since the mask policy with 3 levels + random intercept + random slope for days_since_first
